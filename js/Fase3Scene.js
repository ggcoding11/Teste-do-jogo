class Fase3Scene extends Phaser.Scene {
  ...
  create() {
    ...
    // música de fundo
    this.fase3Music = this.sound.add("musica_fase3", {
      loop: true,
      volume: 0.5,
    });
    this.fase3Music.play();
  ...
  showGameOverScreen() {
    ...
    btn.on("pointerdown", () => {
      if (this.fase3Music) this.fase3Music.stop();
  ...
  checkEndOfWave() {
    if (this.enemies.getChildren().length === 0) {
      if (this.wave < this.maxWaves) {
        ...
        this.time.delayedCall(3000, () => {
          this.fase3Music.stop(); // para a música
          this.scene.stop("Fase3Scene"); // força parar a cena atual
  ...
  spawnEnemyNearby() {
    ...
    const statsMap = {
      avareza1: { health: 350, speed: 150, damage: 20, scale: 0.11 },
      avareza2: { health: 500, speed: 140, damage: 30, scale: 0.07 },
      avareza3: { health: 800, speed: 100, damage: 45, scale: 0.14 },
    };
