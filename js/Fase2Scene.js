class Fase2Scene extends Phaser.Scene {
  ...
  create() {
    ...
    // música de fundo
    this.fase2Music = this.sound.add("musica_fase2", {
      loop: true,
      volume: 0.5,
    });
    this.fase2Music.play();

    // cenário e limites
    this.add.tileSprite(0, 0, mapSize, mapSize, "fase2_bg").setOrigin(0);
  ...
  showGameOverScreen() {
    ...
    btn.on("pointerdown", () => {
      if (this.fase2Music) this.fase2Music.stop();
  ...
  spawnEnemyNearby() {
    ...
    const statsMap = {
      enemy1: { health: 300, speed: 140, damage: 15 },
      enemy2: { health: 450, speed: 120, damage: 25 },
      enemy3: { health: 700, speed: 90, damage: 35 },
    };
  ...
  spawnMiniBoss() {
    ...
    this.miniBoss.health = 1800; // vida aumentada
    this.miniBoss.speed = 90; // ligeiramente mais rápido
    this.miniBoss.damage = 45; // contato, se quiser
