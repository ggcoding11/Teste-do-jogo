class Fase2Scene extends Phaser.Scene {
  ...
  spawnEnemyNearby() {
    ...
    const statsMap = {
      gula1: { health: 300, speed: 140, damage: 15, scale: 0.1 },
      gula2: { health: 450, speed: 70, damage: 25, scale: 0.08 },
      gula3: { health: 700, speed: 190, damage: 35, scale: 0.1 },
    };
  ...
  spawnMiniBoss() {
    ...
    this.miniBoss.health = 1800;
    this.miniBoss.speed = 90;
    this.miniBoss.damage = 45;
